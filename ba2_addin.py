        ...
        if not self._sparse_data:
            ...
            if (not self._simple_regression) or (self._dot_formula):
                ...
                if self._dot_formula and self._non_dot_formula:
                    dot_translato += '    p = {}'                                                                          +'\n'
                    dot_translato += '    p["training_data"] = np.array(datasets["training_data"])'                        +'\n'
                    dot_translato +=  ''                                                                                   +'\n'
                    dot_translato += '    col_names = list(datasets["training_data"].columns)'                             +'\n'
                    dot_translato += '    y_col_index = col_names.index(y_col)'                                            +'\n'
                    dot_translato += '    x_col_indices = [i for i in range(len(col_names)) if col_names[i] in x_cols]'    +'\n'
                    dot_translato  +=  ''                                                                                  +'\n'
                    dot_translato  +=  '    output_data["training_data"] = ('                                              +'\n'
                    dot_translato  +=  '                {"y" : p["training_data"][:, y_col_index].transpose(),'            +'\n'
                    dot_translato  +=  '                 "X" : p["training_data"][:, x_col_indices]})'                     +'\n'
                else:
                    dot_translato  +=  '    output_data["training_data"] = ('                                              +'\n'
